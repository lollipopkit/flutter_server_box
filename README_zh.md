...
macOS | [AppStore](https://apps.apple.com/app/id1586449703)（仅 Apple Silicon） / [GitHub](https://github.com/lollipopkit/flutter_server_box/releases)（`.dmg`，按架构分别提供） / brew install --cask server-box
