...
flutter_rust_bridge::frb_generated_boilerplate!(
                ...
                pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -786147786;
...
let api_build_number = <String>::sse_decode(&mut deserializer);deserializer.end();
            ...
            }fn wire__crate__api__file__copy_file_exclusive_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "copy_file_exclusive", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || {
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_source = <String>::sse_decode(&mut deserializer);
let api_destination = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, String>((move ||  {
...
let api_temp_divisor = <f64>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
            ...
            }fn wire__crate__api__virt__parse_virt_create_volume_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "parse_virt_create_volume", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || {
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_raw = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, crate::api::virt::VirtFfiError>((move ||  {
                         let output_ok = crate::api::virt::parse_virt_create_volume(api_raw)?;   std::result::Result::Ok(output_ok)
                    })())
                } })
...
let api_name = <String>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse::<_, ()>((move || {
                     let output_ok = Ok::<_, ()>(crate::api::virt::virt_snapshot_delete_script(api_domain, api_name))?;   std::result::Result::Ok(output_ok)
                })()) })
...
let api_running = <bool>::sse_decode(&mut deserializer);deserializer.end();
            ...
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_domain = <String>::sse_decode(&mut deserializer);
let api_storage = <Vec<String>>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse::<_, crate::api::virt::VirtFfiError>((move || {
                     let output_ok = crate::api::virt::virt_undefine_script(api_domain, api_storage)?;   std::result::Result::Ok(output_ok)
                })()) })
...
40 => wire__crate__api__virt__parse_virt_create_host_json_impl(port, ptr, rust_vec_len, data_len),
41 => wire__crate__api__virt__parse_virt_create_json_impl(port, ptr, rust_vec_len, data_len),
42 => wire__crate__api__virt__parse_virt_create_volume_impl(port, ptr, rust_vec_len, data_len),
43 => wire__crate__api__virt__parse_virt_domain_detail_json_impl(port, ptr, rust_vec_len, data_len),
44 => wire__crate__api__virt__parse_virt_hardware_change_json_impl(port, ptr, rust_vec_len, data_len),
45 => wire__crate__api__virt__parse_virt_hardware_json_impl(port, ptr, rust_vec_len, data_len),
46 => wire__crate__api__virt__parse_virt_host_devices_json_impl(port, ptr, rust_vec_len, data_len),
47 => wire__crate__api__virt__parse_virt_networks_json_impl(port, ptr, rust_vec_len, data_len),
48 => wire__crate__api__virt__parse_virt_overview_json_impl(port, ptr, rust_vec_len, data_len),
49 => wire__crate__api__virt__parse_virt_probe_json_impl(port, ptr, rust_vec_len, data_len),
50 => wire__crate__api__virt__parse_virt_snapshots_json_impl(port, ptr, rust_vec_len, data_len),
51 => wire__crate__api__virt__parse_virt_storage_json_impl(port, ptr, rust_vec_len, data_len),
52 => wire__crate__api__virt__parse_virt_vnc_console_json_impl(port, ptr, rust_vec_len, data_len),
53 => wire__crate__api__virt__parse_virt_volumes_json_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
                }
...
54 => wire__crate__api__parser__parse_windows_net_speed_json_impl(ptr, rust_vec_len, data_len),
55 => wire__crate__api__script__read_custom_cmds_command_impl(ptr, rust_vec_len, data_len),
56 => wire__crate__api__script__script_segment_marker_impl(ptr, rust_vec_len, data_len),
57 => wire__crate__api__script__shell_func_flag_impl(ptr, rust_vec_len, data_len),
58 => wire__crate__api__virt__virt_action_script_impl(ptr, rust_vec_len, data_len),
59 => wire__crate__api__virt__virt_console_command_impl(ptr, rust_vec_len, data_len),
60 => wire__crate__api__virt__virt_create_host_script_impl(ptr, rust_vec_len, data_len),
61 => wire__crate__api__virt__virt_create_volume_script_impl(ptr, rust_vec_len, data_len),
62 => wire__crate__api__virt__virt_define_script_impl(ptr, rust_vec_len, data_len),
63 => wire__crate__api__virt__virt_domain_detail_script_impl(ptr, rust_vec_len, data_len),
64 => wire__crate__api__virt__virt_hardware_change_script_impl(ptr, rust_vec_len, data_len),
65 => wire__crate__api__virt__virt_hardware_script_impl(ptr, rust_vec_len, data_len),
66 => wire__crate__api__virt__virt_host_devices_script_impl(ptr, rust_vec_len, data_len),
67 => wire__crate__api__virt__virt_networks_script_impl(ptr, rust_vec_len, data_len),
68 => wire__crate__api__virt__virt_overview_script_impl(ptr, rust_vec_len, data_len),
69 => wire__crate__api__virt__virt_probe_script_impl(ptr, rust_vec_len, data_len),
70 => wire__crate__api__virt__virt_snapshot_create_script_impl(ptr, rust_vec_len, data_len),
71 => wire__crate__api__virt__virt_snapshot_delete_script_impl(ptr, rust_vec_len, data_len),
72 => wire__crate__api__virt__virt_snapshot_revert_script_impl(ptr, rust_vec_len, data_len),
73 => wire__crate__api__virt__virt_snapshots_script_impl(ptr, rust_vec_len, data_len),
74 => wire__crate__api__virt__virt_storage_script_impl(ptr, rust_vec_len, data_len),
75 => wire__crate__api__virt__virt_undefine_script_impl(ptr, rust_vec_len, data_len),
76 => wire__crate__api__virt__virt_vnc_console_script_impl(ptr, rust_vec_len, data_len),
77 => wire__crate__api__virt__virt_volumes_script_impl(ptr, rust_vec_len, data_len),
78 => wire__crate__api__ssh_asym__x25519_keypair_impl(ptr, rust_vec_len, data_len),
79 => wire__crate__api__ssh_asym__x25519_shared_secret_impl(ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
                }
