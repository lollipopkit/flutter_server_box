...
let api_seed = <Option<String>>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse::<_, crate::api::virt::VirtFfiError>((move || {
                     let output_ok = crate::api::virt::virt_undefine_script(api_domain, api_storage, api_seed)?;   std::result::Result::Ok(output_ok)
                })()) })
