...
<p align="center">A modern Flutter application for managing Linux servers with SSH, SFTP, Docker, and system monitoring.</p>
...
<p align="center">
A Flutter project which provide charts to display <a href="https://github.com/lollipopkit/flutter_server_box/issues/43">Linux</a> and Windows server status and tools to manage servers.
<br>
...
- `Status chart` (CPU, Sensors, GPU...), `SSH` Term, `SFTP`, `Docker & Process & Systemd`, `S.M.A.R.T`, `Windows support`...
