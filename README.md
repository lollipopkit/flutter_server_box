...
| macOS | [AppStore](https://apps.apple.com/app/id1586449703) (Apple Silicon only) / [GitHub](https://github.com/lollipopkit/flutter_server_box/releases) (`.dmg`, one per architecture) / brew install --cask server-box |
