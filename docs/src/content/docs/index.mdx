...
<CardGrid stagger>
	<Card title="Real-time Monitoring" icon="chart">
		Monitor CPU, memory, disk, network, GPU, and temperature with real-time charts.
	</Card>
	...
	<Card title="Docker / Podman Management" icon="box">
