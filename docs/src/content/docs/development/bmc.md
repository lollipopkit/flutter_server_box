---
title: BMC Implementation
description: Redfish integration, resource discovery, and hardware behavior
---
...
This page documents the Redfish implementation and its observed hardware behavior. For the BMC user guide, see [BMC (Redfish)](/docs/advanced/bmc/); for the feature rationale and scope, see [BMC overview](/docs/principles/bmc/).
