---
title: インストール
description: お使いのデバイスに Flutter Server Box をダウンロードしてインストールする
---

Flutter Server Box は複数のプラットフォームで利用可能です。お好みのインストール方法を選択してください。
...
iOS アプリの一部として **[App Store](https://apps.apple.com/app/flutter-server-box)** で利用可能です。

## ソースからのビルド

Flutter Server Box をソースからビルドするには、開発ドキュメントの [ビルド](/ja/development/building/) セクションを参照してください。
