...
### ローカルストレージ: AppDb/SQLCipher + PrefStore

- **AppDb + Drift**: 構造化データ向けのリレーショナルなローカル永続化
- **SQLCipher**: 機微なデータベーステーブルを保存時に暗号化
- **PrefStore**: 軽量なキー/バリュー設定や履歴を管理
- **Store API**: バックエンドの詳細を統一インターフェースで隠蔽
