---
title: Inicio Rápido
description: Comienza a usar Flutter Server Box en cuestión de minutos
---
...
- Explora la sección de [Funcionalidades](/es/features/docker/) para guías detalladas
- Configura [Llaves SSH](/es/configuration/server/) para autenticación sin contraseña
- Personaliza tu experiencia en los [Ajustes](/es/configuration/appearance/)
