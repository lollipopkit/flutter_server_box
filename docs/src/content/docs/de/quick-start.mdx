---
title: Schnellstart
description: In wenigen Minuten mit Flutter Server Box loslegen
---
...
1. Öffnen Sie Flutter Server Box
...
- Erkunden Sie den Bereich [Funktionen](/de/features/docker/) für detaillierte Anleitungen
- Konfigurieren Sie [SSH-Schlüssel](/de/configuration/server/) für die passwortlose Authentifizierung
- Passen Sie Ihr Erlebnis in den [Einstellungen](/de/configuration/appearance/) an
