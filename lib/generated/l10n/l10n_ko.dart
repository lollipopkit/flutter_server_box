...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get distIconConsent =>
      '켜면 이 마크를 자발적으로 표시하는 것이며, 그 용도는 해당 서버가 실행 중인 것으로 보이는 배포판을 나타내는 것뿐입니다.';

  @override
  String get distIconIntroLegal =>
      '이 앱은 배포판 마크를 전혀 포함하지 않습니다. 이미지 주소를 설정하면 그곳에서 불러오며, 출처는 사용자가 정하고 설정하지 않으면 아무것도 표시되지 않습니다. 마크는 이 기기가 원격 시스템에서 읽은 내용만을 나타내며, 그 정보는 틀리거나 오래되었을 수 있고 파생판·재빌드·특정 버전을 뜻하지도 않습니다.\n\n각 마크는 해당 소유자의 상표이며, 여기서는 그것이 가리키는 시스템을 지칭하는 데에만 사용됩니다.';
