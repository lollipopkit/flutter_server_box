...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get distIconIntroLegal =>
      'Значки взяты из font-logos — перерисованы и переданы в общественное достояние. Это не изображения самих проектов, на которые они указывают; ни один проект не проверял и не одобрял это приложение и не связан с ним.\n\nЗначок отражает лишь то, что это устройство прочитало с удалённой системы, и эти сведения могут быть неверными или устаревшими. Он не обозначает производную сборку, пересборку или конкретную версию. Если систему определить не удалось или её значок не поставляется, вместо него рисуется нейтральный контур.\n\nКаждый значок является товарным знаком соответствующего владельца и используется здесь только для указания на систему, которую он обозначает.';

  @override
  String get distIconIntroTitle => 'Значки дистрибутивов';
