...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get crashReportHint =>
      'Это журнал предыдущего запуска. Имена серверов, адреса и имена пользователей заменены заполнителями, но всё же прочитайте его перед публикацией. При копировании полный отчёт помещается в буфер обмена.';
