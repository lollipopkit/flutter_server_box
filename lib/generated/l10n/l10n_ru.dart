...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get crashReportHint =>
      'Это журнал предыдущего запуска. Известные имена и адреса серверов заменены заполнителями, но другие данные могут остаться — прочитайте его перед публикацией. При копировании полный отчёт помещается в буфер обмена.';
