...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get crashCollectBasicTip =>
      'Только сам сбой и версия приложения, в которой он произошёл. Ваши действия не записываются.';
  ...
  String get crashCollectFullTip =>
      'Помимо данных о моменте возникновения проблемы, отправляются журналы и данные о производительности во время работы приложения.';

  @override
  String get crashCollectFooter =>
      'На всех уровнях имена серверов, адреса и имена пользователей заменяются заполнителями уже при записи. Позже уровень сбора можно изменить в настройках.';
