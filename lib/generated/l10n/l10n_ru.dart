...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get markUrlTip =>
      'Маленький знак рядом с именем сервера в списках. Пусто — не показывать.\n\nЭто не то же изображение, что логотип, и рисуется иначе: знак принимает цвет соседнего текста, чтобы столбец читался как столбец. Логотип остаётся таким, каким опубликован.';
