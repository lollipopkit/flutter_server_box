...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get distIconIntroLegal =>
      'このアプリはディストリビューションのマークを一切同梱していません。画像のアドレスを設定すると、そこから読み込まれます。取得元はあなたが選ぶもので、設定しなければ何も表示されません。マークは、この端末がリモートシステムから読み取った内容を示すだけで、その情報は誤っていたり古かったりすることがあり、派生版・再構築版・特定のバージョンを表すものでもありません。\n\n各マークはそれぞれの所有者の商標であり、ここではそれが指すシステムを示す目的にのみ使用しています。';
