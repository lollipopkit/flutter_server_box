...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get crashReportHint =>
      'Це журнал попереднього запуску. Імена серверів, адреси та імена користувачів замінено заповнювачами, але все одно прочитайте його перед публікацією. Копіювання помістить повний звіт у буфер обміну.';
