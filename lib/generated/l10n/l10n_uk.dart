...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get distIconConsent =>
      'Вмикаючи це, ви самі обираєте показувати ці позначки — виключно для того, щоб позначити дистрибутив, який, схоже, працює на сервері.';

  @override
  String get distIconIntroLegal =>
      'Цей застосунок не містить жодних знаків дистрибутивів. Щойно ви вкажете адресу, зображення завантажуватиметься звідти — джерело обираєте ви, а поки його не вказано, нічого не показується. Знак свідчить лише про те, що цей пристрій прочитав із віддаленої системи; ці відомості можуть бути хибними або застарілими і не позначають ані похідну збірку, ані перезбирання, ані якусь конкретну версію.\n\nКожен знак є торговельною маркою свого власника і використовується тут лише для позначення системи, яку він ідентифікує.';
  ...
  String get markUrlTip =>
      'Маленька позначка поряд з іменем сервера у списках. Порожньо — не показувати.\n\nЦе не те саме зображення, що логотип, і малюється інакше: позначка набирає кольору сусіднього тексту, щоб стовпець читався як стовпець. Логотип лишається таким, яким його опубліковано.';
