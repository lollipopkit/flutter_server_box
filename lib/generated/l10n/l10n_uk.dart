...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get crashReportHint =>
      'Це журнал попереднього запуску. Відомі імена та адреси серверів замінено заповнювачами, але інші дані можуть залишитися — прочитайте його перед публікацією. Копіювання помістить повний звіт у буфер обміну.';
