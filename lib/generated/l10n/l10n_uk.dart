...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get logoUrlTip => 'Велике зображення вгорі сторінки сервера.';
  ...
  String get markUrlTip =>
      'Маленька позначка поряд з іменем сервера у списках. Порожньо — не показувати.\n\nЦе не те саме зображення, що логотип: малюнок, читабельний на всю ширину, при 20 px перетворюється на пляму.';
