...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get crashCollectBasicTip =>
      'Лише сам збій і версія застосунку, у якій він стався. Ваші дії не записуються.';
  ...
  String get crashCollectFullTip =>
      'Окрім даних про момент виникнення проблеми, надсилаються журнали й дані про продуктивність під час роботи застосунку.';

  @override
  String get crashCollectFooter =>
      'На всіх рівнях імена серверів, адреси та імена користувачів замінюються заповнювачами вже під час запису. Пізніше рівень збору можна змінити в налаштуваннях.';
  ...
  String get crashUploadTip =>
      'Надсилати звіти про збої розробнику, а не лише зберігати їх на цьому пристрої. Відомі імена та адреси серверів замінюються заповнювачами, але інші дані можуть залишитися. Типово вимкнено; можна вимкнути будь-коли.';
