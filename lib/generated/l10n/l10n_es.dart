...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get askAiProtocol => 'Protocolo de API';
  ...
  @override
  String get askAiProtocolAuto => 'Automático';
  ...
  @override
  String get askAiReady => 'Listo';

  @override
  String get askAiThinking => 'Pensando';

  @override
  String get askAiRunningCommand => 'Ejecutando';
  ...
  @override
  String get askAiCommandCancelled => 'Cancelado';

  @override
  String get askAiCommandTimedOut => 'Tiempo agotado';
  ...
  @override
  String get askAiClearHistory => 'Borrar historial';
  ...
  @override
  String get shellSourceNone => 'Sin shell';

  @override
  String get forceSinglePane => 'Una sola columna';

  @override
  String get forceSinglePaneTip =>
      'Mantener una columna sea cual sea el ancho de la ventana, en vez de mostrar los detalles junto a la lista.';

  @override
  String get passwordlessTerminal => 'Terminal sin credenciales';

  @override
  String get passwordlessTerminalTip =>
      'Abrir un terminal a través del agente monitor sin credenciales SSH. El shell se ejecuta con la cuenta con la que se ejecuta el agente, así que basta con la contraseña de monitor para obtenerlo: no se aplica la autenticación, el registro ni el segundo factor de sshd. El agente decide si lo permite. Solo ofrece un terminal: SFTP, reenvío de puertos, contenedores, procesos y systemd necesitan SSH.';

  @override
  String get passwordlessTerminalNeedsMonitor =>
      'Un terminal sin credenciales requiere una dirección de monitor.';

  @override
  String get passwordlessTerminalConflictsWithSsh =>
      'Un terminal sin credenciales no puede combinarse con credenciales SSH.';
  ...
  @override
  String get sshViaMonitor => 'SSH a través de monitor';

  @override
  String get sshViaMonitorTip =>
      'Accede al SSH de este servidor mediante su agente monitor, para equipos cuyo puerto SSH no es accesible directamente. El agente solo retransmite bytes: la sesión sigue cifrada de extremo a extremo y su clave de host se sigue verificando aquí. La dirección de destino se configura en el agente y no se puede elegir desde la app.';

  @override
  String get sshViaMonitorNeedsMonitor =>
      'SSH a través de monitor requiere una dirección de monitor.';

  @override
  String get sshViaMonitorConflictsWithOtherTransport =>
      'SSH a través de monitor no se puede combinar con servidor de salto, ProxyCommand ni dirección alternativa.';
  ...
  @override
  String get portForward_type_remote => 'Remoto';
