...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1958706149;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiVirtParseVirtCreateVolume({required String raw});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<bool> crateApiFileCopyFileExclusive({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFileCopyFileExclusiveConstMeta,
        argValues: [source, destination],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFileCopyFileExclusiveConstMeta =>
      const TaskConstMeta(
        debugName: 'copy_file_exclusive',
  ...
  Future<String> crateApiVirtParseVirtCreateVolume({required String raw}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiVirtParseVirtCreateVolumeConstMeta,
        argValues: [raw],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiVirtParseVirtCreateVolumeConstMeta =>
      const TaskConstMeta(
        debugName: 'parse_virt_create_volume',
        argNames: ['raw'],
      );
