...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1975907596;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<PluginStatusCmd> crateApiPluginPluginRuntimeStatusCmd({
    required PluginRuntime that,
    required BigInt instance,
    required String platform,
  });

  Future<PluginStatusResult> crateApiPluginPluginRuntimeStatusParse({
    required PluginRuntime that,
    required BigInt instance,
  ...
  String crateApiScriptPluginCmdsCommand({
    required String system,
  ...
  String? crateApiScriptPluginResultName({required String key});
  ...
  Future<int> crateApiPluginShutdownPluginRuntimes();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<PluginStatusCmd> crateApiPluginPluginRuntimeStatusCmd({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_plugin_status_cmd,
          decodeErrorData: sse_decode_plugin_failure,
        ),
        constMeta: kCrateApiPluginPluginRuntimeStatusCmdConstMeta,
        argValues: [that, instance, platform],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiPluginPluginRuntimeStatusCmdConstMeta =>
      const TaskConstMeta(
        debugName: 'PluginRuntime_status_cmd',
        argNames: ['that', 'instance', 'platform'],
      );
  ...
  Future<PluginStatusResult> crateApiPluginPluginRuntimeStatusParse({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_plugin_status_result,
          decodeErrorData: sse_decode_plugin_failure,
        ),
        constMeta: kCrateApiPluginPluginRuntimeStatusParseConstMeta,
        argValues: [that, instance, text],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiPluginPluginRuntimeStatusParseConstMeta =>
      const TaskConstMeta(
        debugName: 'PluginRuntime_status_parse',
        argNames: ['that', 'instance', 'text'],
      );
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(system, serializer);
          sse_encode_list_plugin_cmd(cmds, serializer);
        ...
        constMeta: kCrateApiScriptPluginCmdsCommandConstMeta,
  ...
  TaskConstMeta get kCrateApiScriptPluginCmdsCommandConstMeta =>
      const TaskConstMeta(
        debugName: 'plugin_cmds_command',
  ...
  String? crateApiScriptPluginResultName({required String key}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiScriptPluginResultNameConstMeta,
        argValues: [key],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiScriptPluginResultNameConstMeta =>
      const TaskConstMeta(debugName: 'plugin_result_name', argNames: ['key']);
  ...
  Future<int> crateApiPluginShutdownPluginRuntimes() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiPluginShutdownPluginRuntimesConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPluginShutdownPluginRuntimesConstMeta =>
      const TaskConstMeta(debugName: 'shutdown_plugin_runtimes', argNames: []);
  ...
  @protected
  PluginPageInfo dco_decode_box_autoadd_plugin_page_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_plugin_page_info(raw);
  }

  @protected
  PluginSettingsInfo dco_decode_box_autoadd_plugin_settings_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_plugin_settings_info(raw);
  }
  ...
  PluginStatusInfo dco_decode_box_autoadd_plugin_status_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_plugin_status_info(raw);
  }

  @protected
  PluginTabInfo dco_decode_box_autoadd_plugin_tab_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_plugin_tab_info(raw);
  }
  ...
  List<PluginCmd> dco_decode_list_plugin_cmd(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_plugin_cmd).toList();
  }

  @protected
  List<PluginStatusItem> dco_decode_list_plugin_status_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_plugin_status_item).toList();
  }
  ...
  @protected
  PluginPageInfo? dco_decode_opt_box_autoadd_plugin_page_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_plugin_page_info(raw);
  }

  @protected
  PluginSettingsInfo? dco_decode_opt_box_autoadd_plugin_settings_info(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null
        ? null
        : dco_decode_box_autoadd_plugin_settings_info(raw);
  }
  ...
  PluginTabInfo? dco_decode_opt_box_autoadd_plugin_tab_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_plugin_tab_info(raw);
  }
  ...
  @protected
  PluginPageInfo dco_decode_plugin_page_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 6)
    ...
    return PluginPageInfo(
      ...
      icon: dco_decode_opt_String(arr[2]),
      defaultOn: dco_decode_bool(arr[3]),
      needs: dco_decode_list_String(arr[4]),
      requiresConfig: dco_decode_bool(arr[5]),
    );
  }
  ...
  @protected
  PluginSettingsInfo dco_decode_plugin_settings_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return PluginSettingsInfo(
      id: dco_decode_String(arr[0]),
      label: dco_decode_String(arr[1]),
      icon: dco_decode_opt_String(arr[2]),
    );
  ...
  PluginStatusCmd dco_decode_plugin_status_cmd(dynamic raw) {
    ...
    return PluginStatusCmd(cmd: dco_decode_String(arr[0]));
  }
  ...
  PluginStatusInfo dco_decode_plugin_status_info(dynamic raw) {
    ...
    return PluginStatusInfo(
      ...
      defaultOn: dco_decode_bool(arr[3]),
      requiresConfig: dco_decode_bool(arr[4]),
      platforms: dco_decode_list_String(arr[5]),
    );
  }
  ...
  PluginStatusResult dco_decode_plugin_status_result(dynamic raw) {
    ...
    return PluginStatusResult(
      ...
      items: dco_decode_list_plugin_status_item(arr[1]),
  ...
  @protected
  PluginPageInfo sse_decode_box_autoadd_plugin_page_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return sse_decode_plugin_page_info(deserializer);
  }

  @protected
  PluginSettingsInfo sse_decode_box_autoadd_plugin_settings_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return sse_decode_plugin_settings_info(deserializer);
  }
  ...
  PluginStatusInfo sse_decode_box_autoadd_plugin_status_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return sse_decode_plugin_status_info(deserializer);
  }
  ...
  PluginTabInfo sse_decode_box_autoadd_plugin_tab_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return sse_decode_plugin_tab_info(deserializer);
  }
  ...
  List<PluginCmd> sse_decode_list_plugin_cmd(SseDeserializer deserializer) {
    ...
    final len_ = sse_decode_i_32(deserializer);
    final ans_ = <PluginCmd>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_plugin_cmd(deserializer));
    }
    return ans_;
  }
  ...
  List<PluginStatusItem> sse_decode_list_plugin_status_item(
    ...
    final len_ = sse_decode_i_32(deserializer);
    final ans_ = <PluginStatusItem>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_plugin_status_item(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  PluginPageInfo? sse_decode_opt_box_autoadd_plugin_page_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return sse_decode_box_autoadd_plugin_page_info(deserializer);
    } else {
      return null;
    }
  }
  ...
  @protected
  PluginSettingsInfo? sse_decode_opt_box_autoadd_plugin_settings_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return sse_decode_box_autoadd_plugin_settings_info(deserializer);
    } else {
      return null;
    }
  }
  ...
  PluginStatusInfo? sse_decode_opt_box_autoadd_plugin_status_info(
    ...
    if (sse_decode_bool(deserializer)) {
      return sse_decode_box_autoadd_plugin_status_info(deserializer);
    } else {
      return null;
    }
  }
  ...
  PluginTabInfo? sse_decode_opt_box_autoadd_plugin_tab_info(
    ...
    if (sse_decode_bool(deserializer)) {
      return sse_decode_box_autoadd_plugin_tab_info(deserializer);
    } else {
      return null;
    }
  }
  ...
  PluginCmd sse_decode_plugin_cmd(SseDeserializer deserializer) {
    ...
    final var_name = sse_decode_String(deserializer);
    final var_cmd = sse_decode_String(deserializer);
    return PluginCmd(name: var_name, cmd: var_cmd);
  }
  ...
  PluginManifestInfo sse_decode_plugin_manifest_info(
    ...
    final var_page = sse_decode_opt_box_autoadd_plugin_page_info(deserializer);
    final var_settings = sse_decode_opt_box_autoadd_plugin_settings_info(
      deserializer,
    );
    final var_tab = sse_decode_opt_box_autoadd_plugin_tab_info(deserializer);
  ...
  @protected
  PluginPageInfo sse_decode_plugin_page_info(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    final var_id = sse_decode_String(deserializer);
    final var_label = sse_decode_String(deserializer);
    final var_icon = sse_decode_opt_String(deserializer);
    final var_defaultOn = sse_decode_bool(deserializer);
    final var_needs = sse_decode_list_String(deserializer);
    final var_requiresConfig = sse_decode_bool(deserializer);
    return PluginPageInfo(
      id: var_id,
      label: var_label,
  ...
  @protected
  PluginSettingsInfo sse_decode_plugin_settings_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    final var_id = sse_decode_String(deserializer);
    final var_label = sse_decode_String(deserializer);
    final var_icon = sse_decode_opt_String(deserializer);
    return PluginSettingsInfo(id: var_id, label: var_label, icon: var_icon);
  }
  ...
  PluginStatusCmd sse_decode_plugin_status_cmd(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    final var_cmd = sse_decode_String(deserializer);
    return PluginStatusCmd(cmd: var_cmd);
  }
  ...
  PluginStatusInfo sse_decode_plugin_status_info(SseDeserializer deserializer) {
    ...
    final var_defaultOn = sse_decode_bool(deserializer);
    final var_requiresConfig = sse_decode_bool(deserializer);
    final var_platforms = sse_decode_list_String(deserializer);
    return PluginStatusInfo(
      id: var_id,
      label: var_label,
      icon: var_icon,
  ...
  PluginStatusItem sse_decode_plugin_status_item(SseDeserializer deserializer) {
    ...
    final var_tone = sse_decode_String(deserializer);
    return PluginStatusItem(
      label: var_label,
      value: var_value,
      percent: var_percent,
  ...
  PluginStatusResult sse_decode_plugin_status_result(
    ...
    final var_items = sse_decode_list_plugin_status_item(deserializer);
  ...
  @protected
  void sse_encode_box_autoadd_plugin_page_info(
    PluginPageInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_plugin_page_info(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_plugin_settings_info(
    PluginSettingsInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_plugin_settings_info(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_plugin_status_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_plugin_status_info(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_plugin_tab_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_plugin_tab_info(self, serializer);
  }
  ...
  void sse_encode_list_plugin_cmd(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_plugin_cmd(item, serializer);
    }
  }
  ...
  void sse_encode_list_plugin_status_item(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_plugin_status_item(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_plugin_page_info(
    PluginPageInfo? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_plugin_page_info(self, serializer);
    }
  }

  @protected
  void sse_encode_opt_box_autoadd_plugin_settings_info(
    PluginSettingsInfo? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_plugin_settings_info(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_plugin_tab_info(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_plugin_tab_info(self, serializer);
    }
  }
  ...
  void sse_encode_plugin_manifest_info(
    ...
    sse_encode_opt_box_autoadd_plugin_page_info(self.page, serializer);
    sse_encode_opt_box_autoadd_plugin_settings_info(self.settings, serializer);
    sse_encode_opt_box_autoadd_plugin_tab_info(self.tab, serializer);
  ...
  @protected
  void sse_encode_plugin_page_info(
    PluginPageInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_opt_String(self.icon, serializer);
    sse_encode_bool(self.defaultOn, serializer);
    sse_encode_list_String(self.needs, serializer);
    sse_encode_bool(self.requiresConfig, serializer);
  }
  ...
  @protected
  void sse_encode_plugin_settings_info(
    PluginSettingsInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_plugin_status_result(
    ...
    sse_encode_list_plugin_status_item(self.items, serializer);
    sse_encode_opt_String(self.note, serializer);
  }

  @protected
  void sse_encode_plugin_tab_info(
    PluginTabInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
...
class PluginRuntimeImpl extends RustOpaque implements PluginRuntime {
  ...
  Future<PluginStatusCmd> statusCmd({
    required BigInt instance,
    required String platform,
  }) => RustLib.instance.api.crateApiPluginPluginRuntimeStatusCmd(
    that: this,
    instance: instance,
    platform: platform,
  );
  ...
  Future<PluginStatusResult> statusParse({
    required BigInt instance,
    required String text,
  }) => RustLib.instance.api.crateApiPluginPluginRuntimeStatusParse(
    that: this,
    instance: instance,
    text: text,
  );
