...
class SSHConfig {
  ...
  static Future<List<Spi>> parseConfig([String? configPath]) async {
    ...
    try {
      ...
      Loggers.app.warning('Failed to read SSH config: $e');
      return [];
    }
  }
    ...
    for (final line in lines) {
      ...
      switch (key) {
        case 'host':
          ...
          final isQuoted = (originalValue.startsWith('"') && originalValue.endsWith('"')) ||
