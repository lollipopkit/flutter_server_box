...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServerState&&const DeepCollectionEquality().equals(other.servers, servers)&&const DeepCollectionEquality().equals(other.serverOrder, serverOrder)&&const DeepCollectionEquality().equals(other.tags, tags)&&const DeepCollectionEquality().equals(other.manualDisconnectedIds, manualDisconnectedIds)&&(identical(other.autoRefreshTimer, autoRefreshTimer) || other.autoRefreshTimer == autoRefreshTimer));
}
...
@override
String toString() {
  return 'ServerState(servers: $servers, serverOrder: $serverOrder, tags: $tags, manualDisconnectedIds: $manualDisconnectedIds, autoRefreshTimer: $autoRefreshTimer)';
}
...
class _ServerState implements ServerState {
  const _ServerState({final  Map<String, Spi> servers = const {}, final  List<String> serverOrder = const [], final  Set<String> tags = const <String>{}, final  Set<String> manualDisconnectedIds = const <String>{}, this.autoRefreshTimer}): _servers = servers,_serverOrder = serverOrder,_tags = tags,_manualDisconnectedIds = manualDisconnectedIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServerState&&const DeepCollectionEquality().equals(other._servers, _servers)&&const DeepCollectionEquality().equals(other._serverOrder, _serverOrder)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._manualDisconnectedIds, _manualDisconnectedIds)&&(identical(other.autoRefreshTimer, autoRefreshTimer) || other.autoRefreshTimer == autoRefreshTimer));
}
...
/// @nodoc
mixin _$IndividualServerState {

 Spi get spi; ServerStatus get status; ServerConn get conn; SSHClient? get client; Future<void>? get updateFuture;
/// Create a copy of IndividualServerState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$IndividualServerStateCopyWith<IndividualServerState> get copyWith => _$IndividualServerStateCopyWithImpl<IndividualServerState>(this as IndividualServerState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IndividualServerState&&(identical(other.spi, spi) || other.spi == spi)&&(identical(other.status, status) || other.status == status)&&(identical(other.conn, conn) || other.conn == conn)&&(identical(other.client, client) || other.client == client)&&(identical(other.updateFuture, updateFuture) || other.updateFuture == updateFuture));
}
...
@override
String toString() {
  return 'IndividualServerState(spi: $spi, status: $status, conn: $conn, client: $client, updateFuture: $updateFuture)';
}
...
/// @nodoc
abstract mixin class $IndividualServerStateCopyWith<$Res>  {
  factory $IndividualServerStateCopyWith(IndividualServerState value, $Res Function(IndividualServerState) _then) = _$IndividualServerStateCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$IndividualServerStateCopyWithImpl<$Res>
    implements $IndividualServerStateCopyWith<$Res> {
  _$IndividualServerStateCopyWithImpl(this._self, this._then);

  final IndividualServerState _self;
  final $Res Function(IndividualServerState) _then;
...
/// Adds pattern-matching-related methods to [IndividualServerState].
extension IndividualServerStatePatterns on IndividualServerState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IndividualServerState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IndividualServerState() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IndividualServerState value)  $default,){
final _that = this;
switch (_that) {
case _IndividualServerState():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IndividualServerState value)?  $default,){
final _that = this;
switch (_that) {
case _IndividualServerState() when $default != null:
return $default(_that);case _:
...
class _IndividualServerState implements IndividualServerState {
  const _IndividualServerState({required this.spi, required this.status, this.conn = ServerConn.disconnected, this.client, this.updateFuture});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$IndividualServerStateCopyWith<_IndividualServerState> get copyWith => __$IndividualServerStateCopyWithImpl<_IndividualServerState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IndividualServerState&&(identical(other.spi, spi) || other.spi == spi)&&(identical(other.status, status) || other.status == status)&&(identical(other.conn, conn) || other.conn == conn)&&(identical(other.client, client) || other.client == client)&&(identical(other.updateFuture, updateFuture) || other.updateFuture == updateFuture));
}
...
/// @nodoc
abstract mixin class _$IndividualServerStateCopyWith<$Res> implements $IndividualServerStateCopyWith<$Res> {
  factory _$IndividualServerStateCopyWith(_IndividualServerState value, $Res Function(_IndividualServerState) _then) = __$IndividualServerStateCopyWithImpl;
@override @useResult
$Res call({
 Spi spi, ServerStatus status, ServerConn conn, SSHClient? client, Future<void>? updateFuture
});
...
/// @nodoc
class __$IndividualServerStateCopyWithImpl<$Res>
    implements _$IndividualServerStateCopyWith<$Res> {
  __$IndividualServerStateCopyWithImpl(this._self, this._then);

  final _IndividualServerState _self;
  final $Res Function(_IndividualServerState) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? spi = null,Object? status = null,Object? conn = null,Object? client = freezed,Object? updateFuture = freezed,}) {
  return _then(_IndividualServerState(
spi: null == spi ? _self.spi : spi // ignore: cast_nullable_to_non_nullable
as Spi,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as ServerStatus,conn: null == conn ? _self.conn : conn // ignore: cast_nullable_to_non_nullable
as ServerConn,client: freezed == client ? _self.client : client // ignore: cast_nullable_to_non_nullable
