...
/// map is a compile error — and `test/unit/server/dist_icon_test.dart` carries the same
...
///
/// `test/unit/server/dist_icon_test.dart` asserts that every case appears here exactly
