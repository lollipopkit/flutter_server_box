...
class ScriptPaths {
  ...
  static void switchScriptDir(String id, {bool isWindows = false}) {
    switch (_scriptDirMap[id]) {
      case ScriptConstants.scriptDirTmp:
        _scriptDirMap[id] = ScriptConstants.scriptDirHome;
      case ScriptConstants.scriptDirTmpWindows:
        _scriptDirMap[id] = ScriptConstants.scriptDirHomeWindows;
      case ScriptConstants.scriptDirHome:
        _scriptDirMap[id] = ScriptConstants.scriptDirTmp;
      case ScriptConstants.scriptDirHomeWindows:
